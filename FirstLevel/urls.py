...
urlpatterns = [
    ...
    path('IDFC_HL_MIS/', views.IDFC_HL_MIS, name='IDFC_HL_MIS'),
    ...
    path('BAJAJ_CD_MIS/', views.BAJAJ_MIS, name='BAJAJ_MIS'),
    ...
    path('login/bajaj_salary.html', views.BAJAJ_SALARY, name='BAJAJ_SALARY'),
