...
urlpatterns = [
    ...
    path('MAGMA_FOS_SALARY/', views.MASTER_SALARY_MAGMA, name='MASTER_SALARY_MAGMA'),
    ...
    path('down27/', views.MAGMA_FOS_SALARY_DOWNLOAD, name='MAGMA_FOS_SALARY_DOWNLOAD'),
    path('down28/', views.SLICE_FOS_SALARY_DOWNLOAD, name='SLICE_FOS_SALARY_DOWNLOAD'),
    path('down29/', views.SLICE_FOS_SALARY_PER_PAID_CASE_DOWNLOAD, name='SLICE_FOS_SALARY_PER_PAID_CASE_DOWNLOAD'),
    path('down30/', views.SLICE_MASTER_FILE_DOWNLOAD, name='SLICE_MASTER_FILE_DOWNLOAD'),
    path('down31/', views.MAGMA_MASTER_FILE_DOWNLOAD, name='MAGMA_MASTER_FILE_DOWNLOAD'),
    ...
    path('SLICE_CC_ANALYSIS/', views.SLICE_AUTO_ANALYSIS, name='SLICE_AUTO_ANALYSIS'),
